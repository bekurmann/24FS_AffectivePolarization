...
lm1_sotomo <- lm(motions_polarization$yes_votes ~ motions_polarization$lr_distance_normalized)
summary(lm1_sotomo)

lm2_sotomo <- lm(motions_polarization$yes_votes ~ motions_polarization$ap_score_normalized)
summary(lm2_sotomo)
