...
lm_migration <- lm(motions_polarization_migration$yes_votes ~ motions_polarization_migration$ap_score_normalized)
...
lm_migration2 <- lm(motions_polarization_migration$yes_votes ~ 
                      motions_polarization_migration$ap_score_normalized + 
...
motions_polarization_migration %>%
  ...
  labs(
    x = "Normalized L/R Distance",
    y = "Normalized AP Score",
    title = "«Migration» - Normalized AP Score ~ Normalized L/R Distance",
    color = "failed/passed"
  )
...
lm_traffic <- lm(motions_polarization_traffic$yes_votes ~ motions_polarization_traffic$ap_score_normalized)
summary(lm_traffic)
...
lm_traffic2 <- lm(motions_polarization_traffic$yes_votes ~ 
                      motions_polarization_traffic$ap_score_normalized + 
...
motions_polarization_traffic %>%
  ...
  labs(
    x = "Normalized L/R Distance",
    y = "Normalized AP Score",
    title = "«Verkehr» - Normalized AP Score ~ Normalized L/R Distance",
    color = "failed/passed"
  )
...
lm_health <- lm(motions_polarization_health$yes_votes ~ motions_polarization_health$ap_score_normalized)
summary(lm_health)
...
lm_health2 <- lm(motions_polarization_health$yes_votes ~ 
                    motions_polarization_health$ap_score_normalized + 
...
motions_polarization_health %>%
  ...
  labs(
    x = "Normalized L/R Distance",
    y = "Normalized AP Score",
    title = "«Gesundheit» - Normalized AP Score ~ Normalized L/R Distance",
    color = "failed/passed"
  )
...
lm_science <- lm(motions_polarization_science$yes_votes ~ motions_polarization_science$ap_score_normalized)
summary(lm_science)
...
lm_science2 <- lm(motions_polarization_science$yes_votes ~ 
                   motions_polarization_science$ap_score_normalized + 
...
motions_polarization_science %>%
  ...
  labs(
    x = "Normalized L/R Distance",
    y = "Normalized AP Score",
    title = "«Wissenschaft» - Normalized AP Score ~ Normalized L/R Distance",
    color = "failed/passed"
  )
...
lm_europa <- lm(motions_polarization_europa$yes_votes ~ motions_polarization_europa$ap_score_normalized)
summary(lm_europa)
...
lm_europa2 <- lm(motions_polarization_europa$yes_votes ~ 
                    motions_polarization_europa$ap_score_normalized + 
...
motions_polarization_europa %>%
  ...
  labs(
    x = "Normalized L/R Distance",
    y = "Normalized AP Score",
    title = "«Europa» - Normalized AP Score ~ Normalized L/R Distance",
    color = "failed/passed"
  )
